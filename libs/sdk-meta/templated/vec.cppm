...
template <typename S, typename T = typename S::E>
struct _Vec {
    using E = T;
    ...
    bool removeAll(Equatable<T> auto const& val) {
        bool changed = false;
    ...
    void insert(usize index, T&& value) { _buf.insert(index, move(value)); }
    ...
    void replace(usize index, T&& value) { _buf[index] = move(value); }
    ...
    void removeUnordered(usize index) {
        ...
        swap(_buf[index], _buf[_buf.len() - 1]);
    ...
    void pushFront(T&& value) { _buf.insert(0, move(value)); }
    ...
    T& emplaceFront(Args&&... args) {
        return _buf.emplace(0, forward<Args>(args)...);
    }
    ...
    void pushBack(T&& value) { insert(len(), move(value)); }
    ...
    T& emplaceBack(Args&&... args) {
        return _buf.emplace(len(), forward<Args>(args)...);
    }
