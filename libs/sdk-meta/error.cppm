...
#define FOREACH_ERROR(ERROR)                                                   \
    ...
    ERROR(NOT_SUPPORTED, notSupported)                                         \
    ERROR(INVALID_STATE, invalidState)                                         \
    ERROR(INVALID_ARGUMENT, invalidArgument)                                   \
    ERROR(OUT_OF_BOUNDS, outOfBounds)                                          \
...
#undef ITER
    ...
    constexpr Error() : _code(Code::UNKNOWN), _msg("unknown error") { }
...
#undef ITER
    ...
    constexpr bool operator==(Code const& code) const { return _code == code; }
};
